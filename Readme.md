...
## LivePerson Account Configuration:
...
3. Enable SDK via Houston, go to - 
    a. Messaging Gateway- Apple
    b. enable SDK Enabled flag to ‘true’
    c. Paste in the app install id from previous step
    d. Paste in the biz id from first step
    
4. In ACFeature,
    Enabled: Common.Async_Messaging, Reports.leReportBuilderAccess, Common.RichContent  
    Disable: ContentProviderAccount, Consumer_Journey_Identity_Only_Support 
    
5. In Site Settings: enabled messaging.sdes, messaging.file.sharing.enabled    
 
CookBook preconfiguration json could be found here:
https://s3.amazonaws.com/lp-mobile-apps/lpabcsdk/huston_config_abc_sdk.json
 username: lptester
 password: lp1234

## Structure content CIM for the [sample app]
(https://s3.amazonaws.com/lp-mobile-apps/lpabcsdk/index.html)

"Welcome bubble" Widget for LE:
https://s3.amazonaws.com/lp-mobile-apps/structureContentWidget/strcutured-content-widget/index.html

       

**Structure content CIM agent to consumer**
```
json:
