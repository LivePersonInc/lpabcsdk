...
///     Once a <code>CIM</code> (custom interactive message) is sent to device, this SDK will allows you to report SDE’s to LivePerson as engagement attributes to enhance the conversation.
...
///   </li>
///   <li>
///     <em>Events callback notification:</em>
///     Once a predefined event <code>ABCEvent</code> is fullfiled, the event callback <code>eventCallback</code> will notify implementors with the event type.
///     The best example is the ability to get notified once a new conversation is initiated by an incoming CIM.
///     The SDK initializer will accept dedicated event subscription to specific events, defines through ‘ABCEvent’ enum, default to ‘allevents’. for unsubscribing ABCEvents, use <code>[.none]</code>.
///   </li>
///   <li>
...
@property (nonatomic, copy) NSString * _Nullable monitoringDomain;
@property (nonatomic, copy) NSString * _Nullable apiType;
